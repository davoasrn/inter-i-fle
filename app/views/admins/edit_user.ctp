...
<table class="newtable">
	...
	<tr>
		<td>UserType* :<?php echo $info['user_type'];?> </td>
		<td><?php $options = array('Network Admin' => 'N/W Admin', 'Studio Admin' => 'Studio Admin' , 'Client' => 'Client' , 'Professionals' => 'Professionals' , 'Collaborator' => 'Collaborator' ,);echo $this->Form->select('user_type', $options,$info['user_type'])?></td>
	</tr>
	<tr>
		<td>Password* : </td>
