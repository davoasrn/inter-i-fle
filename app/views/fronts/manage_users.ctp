...
<h2 class="dash">
	Manage User 
	<a class="button-new" href="<?php echo $this->webroot."fronts/addUser"; ?>" title="Add User">Add New User</a>
...
<table width="100%" class="myTable">
	...
	?>
			...
			<tr>
				...
				<?php echo $html->link($detail['User']['firstname'], array('controller'=>'fronts', 'action' => 'editUser', $Id.'/0'), array('escape' => false, 'title' => 'Edit User')); ?>
				...
				<td class="centeralign">
					...
					<?php echo $html->link('Details', array('controller'=>'fronts', 'action' => 'viewUserDetails', $Id.'/0'), array('id' => 'viewDetailsPopp'.$index, 'escape' => false)); ?></tr> 
	<?php	
		$index += 1;
		} 
	} 
